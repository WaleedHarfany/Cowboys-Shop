...
firebase.initializeApp({
  apiKey: "AIzaSyAtdYFTzhrX0jmciCelC0Sf23bApHNNgQA",
  authDomain: "cowboys-shop-75b1d.firebaseapp.com",
  projectId: "cowboys-shop-75b1d",
  storageBucket: "cowboys-shop-75b1d.appspot.com",
  messagingSenderId: "267529951435",
  appId: "1:267529951435:web:99ab5d1161d6e2e583634e",
  measurementId: "G-5ZP5914RB4"
})
      ...
      <main>
        <div className="mainContainer">
          ...
          <div className="banner">
            ...
            <img
              src="https://firebasestorage.googleapis.com/v0/b/cowboys-shop-75b1d.appspot.com/o/homepic.png?alt=media&token=1a156597-b742-4a42-ad86-814487b7e079"
              alt=""
              className="AdPic"
            />
          </div>
        ...
        <div className="rightMenu">
          ...
          {cart.length === 0 ?
            (<div>
              <img
                src="https://firebasestorage.googleapis.com/v0/b/cowboys-shop-75b1d.appspot.com/o/emptycart.png?alt=media&token=3fb90fa5-2db2-4758-a4b9-c7df884b6b04"
                alt=""
              />
